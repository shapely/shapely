...
import numpy as np
import pygeos
from pygeos import ufuncs
from pygeos import Point, Polygon, box
...
@pytest.mark.parametrize("points, polygon", point_polygon_testdata)
def test_contains(points, polygon):
...
@pytest.mark.parametrize("points, polygon", point_polygon_testdata)
def test_intersects(points, polygon):
