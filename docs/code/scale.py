...
plot_polygon(triangle, ax=ax, add_points=False, color=GRAY)
triangle_a = affinity.scale(triangle, xfact=1.5, yfact=-1)
plot_polygon(triangle_a, ax=ax, add_points=False, color=BLUE)
...
plot_polygon(triangle_b, ax=ax, add_points=False, color=BLUE)
