    ...
    ext_modules = [
        Extension(
            ...
            sources=[
                ...
                "src/geos_funcs_YYd_b.c",
                "src/geos_funcs_Y_O.c",
                "src/geos_funcs_YY_O.c",
                "src/geos_funcs_YYO_b.c",
                "src/geos_funcs_Ydi_Y.c",
                "src/geos_funcs_Ydddd_Y.c",
                "src/vector.c",
            ],
            **ext_options,
        )
