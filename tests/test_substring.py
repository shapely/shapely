...
class SubstringTestCase(unittest.TestCase):
    ...
    def test_return_startsubstring_reversed(self):
        # not normalized
        self.assertEqual(
            substring(self.line1, -1, -500).wkt, LineString([(1, 0), (0, 0)]).wkt
        )
        self.assertEqual(
    ...
    def test_return_endsubstring(self):
        self.assertEqual(
            substring(self.line1, 0.6, 500).wkt, LineString([(0.6, 0), (2, 0)]).wkt
        )
        self.assertEqual(
    ...
    def test_return_endsubstring_reversed(self):
        # not normalized
        self.assertEqual(
            substring(self.line1, 500, -1).wkt, LineString([(2, 0), (1, 0)]).wkt
        )
        self.assertEqual(
    ...
    def test_return_midsubstring(self):
        ...
        self.assertEqual(
            substring(self.line1, -0.6, -0.5).wkt, LineString([(1.4, 0), (1.5, 0)]).wkt
        )
        self.assertEqual(
    ...
    def test_return_midsubstring_reversed(self):
        ...
        self.assertEqual(
            substring(self.line1, -0.5, -0.6).wkt, LineString([(1.5, 0), (1.4, 0)]).wkt
        )
        self.assertEqual(
            substring(self.line1, 0.6, 0.5, True).wkt,
